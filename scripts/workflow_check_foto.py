...
# --- Nuove variabili per l'invio email ---
GMAIL_ADDRESS = os.environ.get("GMAIL_ADDRESS")            # es. tuonome@gmail.com
GMAIL_APP_PASSWORD = os.environ.get("GMAIL_APP_PASSWORD")  # password per le app di Google
EMAIL_RECIPIENTS = [
...
def send_email(subject: str, html_body: str):
    ...
    try:
        ...
        with smtplib.SMTP_SSL("smtp.gmail.com", 465, context=context) as server:
            ...
            server.sendmail(GMAIL_ADDRESS, EMAIL_RECIPIENTS, msg.as_string())
        print(f"📧 Email inviata a: {', '.join(EMAIL_RECIPIENTS)}")
    except Exception as e:
        print(f"⚠️ Errore durante l'invio dell'email: {e}")
