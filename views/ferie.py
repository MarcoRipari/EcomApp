...
def dashboard_dipendente():
    ...
    mio_storico = mio_storico_completo[mio_storico_completo["_fine"] <= oggi & mio_storico_competo.DETTAGLIO.lower() != "rettifica"].copy() if not mio_storico_completo.empty else mio_storico_completo
